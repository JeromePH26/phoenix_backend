  ...
  Future<Map<String, Object?>> _publishAnalyses({
    ...
    for (final row in rows) {
      ...
      final analysisPayload = <String, Object?>{
        ...
        'modelVersion': 'phoenix_daily_pipeline_v2',
        'dataQuality': dataQuality,
        'confidence': confidence,
        'recommendation': recommendation,
        'probabilities': {
          'home': probabilities['home'] ?? probabilities['homeWin'],
          'draw': probabilities['draw'],
          'away': probabilities['away'] ?? probabilities['awayWin'],
          'homeWin': probabilities['homeWin'],
          'awayWin': probabilities['awayWin'],
          'over25': probabilities['over25'],
          'under25': probabilities['under25'],
          'bttsYes': probabilities['bttsYes'],
